...
def kwsmodel(input_shape, dim0=16, catanum=2):
    model = Sequential()
    model.add(Conv2D(dim0, (3, 3), padding='same', strides=(2, 2), input_shape=input_shape, name='ftr00'));
    ...
    model.add(Dense(catanum, name="fc2"))
